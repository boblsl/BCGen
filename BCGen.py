...
print("Intializing the GRU Encoder Graph")
with tf.variable_scope('gru'):
    ...
    gruoutputs, states = tf.nn.dynamic_rnn(multi_cell, input_embeds, dtype=tf.float32)
...
encoder_output = gruoutputs+encoder_output
# ######################################### decoder ############################################################
